...
//namespace LDZ_Code
//{
//    public static class AO_Devices_old
//    {
...
//            protected override int Init_device(uint number)
//            {
//                LDZ_Code.AO_Devices.FTDIController_lib.FT_STATUS ftStatus = LDZ_Code.AO_Devices.FTDIController_lib.FT_STATUS.FT_OTHER_ERROR;
//                UInt32 dwOpenFlag;

//                if (Own_m_hPort == 0)
//                {
//                    dwOpenFlag = Own_dwListDescFlags & ~LDZ_Code.AO_Devices.FTDIController_lib.FT_LIST_BY_INDEX;
//                    dwOpenFlag = Own_dwListDescFlags & ~LDZ_Code.AO_Devices.FTDIController_lib.FT_LIST_ALL;
//                    dwOpenFlag = 0;
//                    if (dwOpenFlag == 0)
//                    {
//                        //uiCurrentIndex = (uint)cmbDevList.SelectedIndex;
//                        ftStatus = LDZ_Code.AO_Devices.FTDIController_lib.FT_Open((uint)number, ref Own_m_hPort);
//                    }
//                    else
//                    {
...
//                if (ftStatus == LDZ_Code.AO_Devices.FTDIController_lib.FT_STATUS.FT_OK)
//                {
//                    // Set up the port
...
//                int result = Convert.ToInt16(LDZ_Code.AO_Devices.FTDIController_lib.FT_Close(Own_m_hPort));
//                return result;
//            }
//            public override string Ask_required_dev_file()
//            {
